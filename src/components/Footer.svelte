<section class='flex justify-center items-center sm:py-16 py-6 flex-col'>
    ...
    <div class=' flex flex-1 flex-col mr-10 col-span-6 justify-center text-center ml-28 max-xs:ml-0 max-md:ml-56'>
      <img src="logo.svg" class="w-[206px] h-[72px]  text-center max-xs:text-left "/>
