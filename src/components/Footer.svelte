<section class='flex justify-center items-center sm:py-16 py-6 flex-col'>
    <div class='flex justify-center items-start max-sm:flex-col max-md:flex-row flex-col max-xl:flex-row mb-8 w-full  '>
   ...
   Copyright By Sayeda Salma Anika <br> All rights reserved
    ...
    <div class="flex flex-row w-full justify-center flex-wrap flex-[2.5] md:mt-0 mt-10 ml-10 max-xs:justify-start">
      ...
      <div  class="flex flex-col ss:my-0 my-4 min-w-[150px] ">
        <h4 class=' font-poppins font-medium text-white text-[18px] leading-[27px] mb-6'>Support</h4>
        <ul>
        <li
